...
def resultExist(probName,algoName,fitName,inst,s,n,k,q):
...
def countJobs(p,a,f,i,s,n,k,q,count):
    if resultExist(p,a,f,i,s,n,k,q) == False:
        return count + 1
    else:
        return count

def writeScript(p,a,f,i,s,n,k,q,chunkSize, track):
    if resultExist(p,a,f,i,s,n,k,q) == False:
