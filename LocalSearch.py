...
class LocalSearch:
    ...
    def run(self, fitName, minimize, restart, compM):
        if compM == 'bf':
            ...
            if fitName == 'fit':
                return self.hyperSearchFit(fitName, minimize, restart, compM)
            elif fitName == 'mean':
                return self.hyperSearchMean(fitName, minimize, restart, compM)
...
#            print '%s\t%.3f' %(a[i][0],a[i][1])
    ...
    def hyperSearchFit(self,fitName, minimize, restart, compM):
        """ 
...
#        print '+ initial', os.times()[0]-start
...
#                        start = os.times()[0]
                        self.updateSC(i)
#                        updateSCT = updateSCT + os.times()[0] - start 
                        self.updateWAS(i)
                        #print 'S', self.sumArr
                        #print 'Z', self.Z
                    initT = initT + os.times()[0] - startR
...
#                updateSCT = updateSCT + os.times()[0] - start
                ...
                if self.oldindiv.bit[bestI] == '1':
                    ...
                    self.oldindiv.bit[bestI] = '1'
#        print 'while loop', os.times()[0] - startWhile
...
#        print 'allT', os.times()[0] - startA
    ...
    def hyperSearchMean(self,fitName, minimize, restart, compM):
        """ 
        performing hyper search using the probability generated by Hyperplane analysis
        """
